...
export default new Command({
   ...
   * @type {TCommandFunc}
   */
  run: async (client: TBotClient, interaction: Message | ChatInputCommandInteraction, _args: any[], _prefix: string) => {
    ...
    try {
      return usagePercent(async (error: Error | null, percent: number | undefined, _sample: number | undefined) => {
        if (error) {
